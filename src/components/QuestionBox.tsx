...
const monstserrat = JetBrains_Mono({ subsets: ['latin'], weight: ["400", "700", "800"] });
    ...
    return (
        ...
        >
            <div className="relative z-10 px-7">
                <p className={`${monstserrat.className} text-white text-sm md:text-md lg:text-lg xl:text-3xl font-bold text-shadow-amber-200 text-shadow px-5`}>
